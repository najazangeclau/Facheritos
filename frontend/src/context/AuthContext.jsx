...
import { loginToApi, setApiToken } from '../services/apiAuth'
    ...
    try {
      ...
      if (userIndex !== -1) {
        ...
        if (userData.role === 'admin') {
          try {
            await loginToApi('admin', password)
          } catch (apiError) {
            console.warn('Login local OK, pero la API Node no respondio:', apiError.message)
          }
        }
